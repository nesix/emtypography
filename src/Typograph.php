...
namespace EMTypography;

/**
 * Class Typograph
 * @package EMTypography
 */
class Typograph extends Base
{
    public $trets = [

        'EMTypography\Tret\Quote',
        'EMTypography\Tret\Dash',
        'EMTypography\Tret\Symbol',
        'EMTypography\Tret\Punctmark',
        'EMTypography\Tret\Number',
        'EMTypography\Tret\Space',
        'EMTypography\Tret\Abbr',
        'EMTypography\Tret\Nobr',
        'EMTypography\Tret\Date',
        'EMTypography\Tret\OptAlign',
        'EMTypography\Tret\Etc',
        'EMTypography\Tret\Text'
