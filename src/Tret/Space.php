...
namespace EMTypography\Tret;


use EMTypography\Tret;

/**
 * Class Space
 * @package EMTypography\Tret
 */
    ...
    public $rules = array(
        ...
        'autospace_after_dot' => array(
            ...
            'replacement' 	=> array(
                //'\1\2. \4',
                '$m[1].$m[2]."." .( $m[5] == "." ? "" : " ").$m[4].$m[5]',
                '$m[1].$m[2]."." .(in_array(\EMTypography\Lib::strtolower($m[3]), $this->domain_zones)? "":( $m[4] == "." ? "" : " ")). $m[3].$m[4]'
            ),
        ),
